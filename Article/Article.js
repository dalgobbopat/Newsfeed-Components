...
*/
const articleCreator = (titleText, dateText, paragraphOne, paragraphTwo, paragraphThree) => {
    ...
    openButton.addEventListener('click', articleToggle);
...
data.map((currentItem) => {
    const newArticle = articleCreator(currentItem.title, currentItem.date, currentItem.firstParagraph, currentItem.secondParagraph, currentItem.thirdParagraph);
